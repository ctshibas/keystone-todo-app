...
const outerGutter = 40, innerGutter = 20, Positioner = styled__default.default.div(({width: width}) => ({
  ...
  return attachTo ? reactDom.createPortal(React__default.default.createElement(React.Fragment, null, React__default.default.createElement(modalUtils.Blanket, {
    ...
    id: dialogTitleId
  }, heading, " Dialog"), heading ? React__default.default.createElement(Header, null, React__default.default.createElement(Title, null, heading)) : null, React__default.default.createElement(ScrollLock__default.default, null, React__default.default.createElement(Body, null, children)), footer ? React__default.default.createElement(Footer, null, footer) : null)))), attachTo) : null;
});

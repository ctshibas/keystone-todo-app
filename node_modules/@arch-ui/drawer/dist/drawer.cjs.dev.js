...
const Positioner = (_ref) => {
  let {
    ...
    style: {
      ...
      style = _objectWithoutProperties__default['default'](_ref.style, ["transform"]),
      props = _objectWithoutProperties__default['default'](_ref, ["slideInFrom", "width", "stackIndex", "style"]);
...
const Dialog = /*#__PURE__*/react.forwardRef((_ref2, ref) => {
  let {
    component: Tag
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["component"]);

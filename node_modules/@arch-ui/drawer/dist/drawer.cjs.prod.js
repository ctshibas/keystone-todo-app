...
var _extends__default = _interopDefault(_extends), _defineProperty__default = _interopDefault(_defineProperty), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), styled__default = _interopDefault(styled), ScrollLock__default = _interopDefault(ScrollLock), FocusTrap__default = _interopDefault(FocusTrap);
...
const innerGutter = 2 * theme.gridSize, Positioner = _ref => {
  let {slideInFrom: slideInFrom, width: width, stackIndex: stackIndex, style: {transform: transform}} = _ref, style = _objectWithoutProperties__default.default(_ref.style, [ "transform" ]), props = _objectWithoutProperties__default.default(_ref, [ "slideInFrom", "width", "stackIndex", "style" ]);
  const stackTransforms = stackIndex <= 0 ? [] : [ `translate(calc(${.3 * stackIndex} * -9vw))`, `scale(${1 - stackIndex / 50})` ];
  ...
  let {component: Tag} = _ref2, props = _objectWithoutProperties__default.default(_ref2, [ "component" ]);
...
function ModalDialogComponent({attachTo: attachTo = ("undefined" != typeof document ? document.body : null), children: children, closeOnBlanketClick: closeOnBlanketClick = !1, component: component = "div", footer: footer, heading: heading, initialFocus: initialFocus, onClose: onClose, slideInFrom: slideInFrom, width: width = 640, onKeyDown: onKeyDown, transitionState: transitionState, isOpen: isOpen}) {
  ...
  return attachTo ? reactDom.createPortal(core.jsx(react.Fragment, null, isOpen ? core.jsx(modalUtils.Blanket, {
    ...
    id: dialogTitleId
  }, heading, " Dialog"), heading ? core.jsx(Header, null, core.jsx(typography.Title, null, heading)) : null, core.jsx(ScrollLock__default.default, null, core.jsx(Body, null, children)), footer ? core.jsx(Footer, null, footer) : null)))), attachTo) : null;
}

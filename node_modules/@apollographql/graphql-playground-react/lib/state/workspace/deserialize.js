...
exports.deserializePersistedState = void 0;
...
function deserializeSessionsState(state) {
    ...
    var selectedSessionId = state.selectedSessionId && state.selectedSessionId !== '' ? state.selectedSessionId : sessions.first().id;

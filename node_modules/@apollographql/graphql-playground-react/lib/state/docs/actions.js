...
exports.showDocForReference = exports.changeKeyMove = exports.changeWidthDocs = exports.setDocsVisible = exports.toggleDocs = exports.addStack = exports.setStacks = void 0;
...
exports.setStacks = (_a = redux_actions_1.createActions({
    ...
    TOGGLE_DOCS: function TOGGLE_DOCS(sessionId, activeTabIdx) {
        return { sessionId: sessionId, activeTabIdx: activeTabIdx };
    },

...
exports.makeSessionState = exports.SessionState = exports.sessionFromTab = exports.ResponseRecord = exports.Session = void 0;
...
function sessionFromTab(tab) {
    return new Session(__assign(__assign({}, tab), { headers: tab.headers ? JSON.stringify(tab.headers, null, 2) : '', responses: tab.responses && tab.responses.length > 0 ? immutable_1.List(tab.responses.map(function (r) {

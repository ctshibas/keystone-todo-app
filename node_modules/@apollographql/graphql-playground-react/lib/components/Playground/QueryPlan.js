...
var QueryPlanViewer = /** @class */function (_super) {
    ...
    QueryPlanViewer.prototype.render = function () {
        return this.props.isQueryPlanSupported ? React.createElement(QueryPlanCodeMirror, { ref: this.setRef }) : React.createElement(
            NotSupported,
            null,
            "This GraphQL server either doesn't support Apollo Federation, or the query plan extensions is disabled. See the",
            ' ',
            React.createElement(
                "a",
                { target: "_blank", rel: "noopener noreferrer", href: "https://www.apollographql.com/docs/apollo-server/federation/introduction" },
                "docs"
            ),
            ' ',

...
var SideTabs = /** @class */function (_super) {
    ...
    SideTabs.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                TabContentContainer,
                { onKeyDown: this.handleKeyDown, onMouseMove: this.handleMouseMove, tabIndex: activeTabIdx, color: activeTab ? activeTab.props.activeColor : undefined, ref: this.setContentContainerRef },
                activeTab && React.cloneElement(activeTab.props.children, __assign(__assign({}, activeTab.props), { ref: this.props.setActiveContentRef, setWidth: this.props.setWidth }))
            )
        );
    };
    return SideTabs;

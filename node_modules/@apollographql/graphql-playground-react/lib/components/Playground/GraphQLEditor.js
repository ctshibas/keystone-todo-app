...
var GraphQLEditor = /** @class */function (_super) {
    ...
    function GraphQLEditor() {
        ...
        _this.handleExtensionsDrawerResizeStart = function (downEvent) {
            ...
            if (wasOpen && (downEvent.target === _this.tracingRef || downEvent.target === _this.queryPlanRef)) {
                return;
            }
            var onMouseMove = function onMouseMove(moveEvent) {
                if (moveEvent.buttons === 0) {
    ...
    GraphQLEditor.prototype.render = function () {
        return React.createElement(
            ...
            { ref: this.setContainerComponent },
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    DrawerTab,
                                    { isActive: this.props.queryVariablesActive, ref: this.setQueryVariablesRef, onClick: this.props.openQueryVariables },
                                    "Query Variables"
                                ),
                                React.createElement(
                                    DrawerTab,
                                    { isActive: !this.props.queryVariablesActive, ref: this.setHttpHeadersRef, onClick: this.props.closeQueryVariables },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ExtensionsDrawer,
                            { isOpen: this.props.isExtensionsDrawerOpen, height: this.props.responseTracingHeight },
                            React.createElement(
                                ExtensionsDrawerTitle,
                                { isOpen: this.props.isExtensionsDrawerOpen, onMouseDown: this.handleExtensionsDrawerResizeStart },
                                React.createElement(
                                    DrawerTab,
                                    { isActive: this.props.isTracingActive, ref: this.setTracingRef, onClick: this.props.openTracing },
                                    "Tracing"
                                ),
                                React.createElement(
                                    DrawerTab,
                                    { isActive: !this.props.isTracingActive, ref: this.setQueryPlanRef, onClick: this.props.closeTracing },
                                    "Query Plan"
                                )
                            ),
                            this.props.isTracingActive ? React.createElement(ResponseTracing_1.default, null) : React.createElement(QueryPlan_1.QueryPlan, null)
                        )
                    )
                )
            ),
            React.createElement(
                SideTabs_1.default,
                { setActiveContentRef: this.setSideTabActiveContentRef, setWidth: this.setDocsWidth },
                React.createElement(
                    SideTab_1.default,
...
var DrawerTab = index_1.styled('button')(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  padding: 0;\n  margin-right: 10px;\n  background: transparent;\n\n  text-transform: uppercase;\n  font-weight: 600;\n  letter-spacing: 0.53px;\n  line-height: 14px;\n  font-size: 14px;\n  color: ", ";\n  &:last-child {\n    margin-right: 0;\n  }\n"], ["\n  padding: 0;\n  margin-right: 10px;\n  background: transparent;\n\n  text-transform: uppercase;\n  font-weight: 600;\n  letter-spacing: 0.53px;\n  line-height: 14px;\n  font-size: 14px;\n  color: ", ";\n  &:last-child {\n    margin-right: 0;\n  }\n"])), function (p) {
    return p.isActive ? p.theme.editorColours.drawerText : p.theme.editorColours.drawerTextInactive;
});

    ...
    TopBar.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                UrlBarWrapper,
                null,
                React.createElement(UrlBar, { value: this.props.endpoint, onChange: this.onChange, onKeyDown: this.onKeyDown, onBlur: this.props.refetchSchema, disabled: this.props.fixedEndpoint, active: !this.props.fixedEndpoint }),
                endpointUnreachable ? React.createElement(
                    ReachError,
                    null,
                    React.createElement(
                        "span",
                    ...
                    React.createElement(SchemaReload_1.default, { settings: settings, isPollingSchema: this.props.isPollingSchema, onReloadSchema: this.props.refetchSchema })
                )
            ),
            React.createElement(
                exports.Button,
            ...
            this.props.shareEnabled && React.createElement(
                Share_1.default,
                null,
                React.createElement(
                    exports.Button,
...
var Spinner = function Spinner() {
    return React.createElement(
        SpinnerWrapper,
        null,
        React.createElement(Pulse, null)
    );
};

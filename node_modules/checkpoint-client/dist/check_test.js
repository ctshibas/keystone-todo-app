...
function spawn(state) {
  return cp__default['default'].spawn(
    process.execPath,
...
describe('check', () => {
  ...
  describe('simple', function () {
    ...
    it('should go to mock server', async () => {
      ...
      assert__default['default'].equal(result.status, 'waiting');
      ...
      assert__default['default'].deepStrictEqual(calls, 1);
    });
    ...
    it('should use cache', async () => {
      ...
      assert__default['default'].equal(result.status, 'ok');
    ...
    it('should ignore cache if new version', async () => {
      ...
      assert__default['default'].deepStrictEqual(calls, 2);
    });
    ...
    it('should return reminded if recently reminded', async () => {
      ...
      assert__default['default'].equal(result.status, 'reminded');
  ...
  it.skip('should work with our production endpoint and wait for result', async () => {
    ...
    assert__default['default'].equal(code, 0);
    assert__default['default'].equal(stderr, '');
    // check the child
  ...
  it('test bad server', async () => {
    ...
    const { code, stdout, stderr } = await wait(result.data);
    assert__default['default'].equal(code, 1);
    assert__default['default'].equal(stdout, '');
  ...
  describe('disable', () => {
    ...
    it('test', async () => {
      ...
      assert__default['default'].deepStrictEqual(calls, 0);
      assert__default['default'].equal(result.status, 'disabled');
    });
  });
  ...
  it('checkpoint should be import-able', async function () {
    ...
    assert__default['default'].equal(typeof checkpoint.check, 'function');
  });
});

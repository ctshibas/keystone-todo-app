...
describe('download', () => {
    ...
    test('basic download', async () => {
        ...
        expect(await download_1.getVersion(queryEnginePath)).toMatchInlineSnapshot(`"query-engine 6a8054bb549e4cc23f157b0010cb2e95cb2637fb"`);
        expect(await download_1.getVersion(introspectionEnginePath)).toMatchInlineSnapshot(`"introspection-core 6a8054bb549e4cc23f157b0010cb2e95cb2637fb"`);
        expect(await download_1.getVersion(migrationEnginePath)).toMatchInlineSnapshot(`"migration-engine-cli 6a8054bb549e4cc23f157b0010cb2e95cb2637fb"`);
        expect(await download_1.getVersion(prismafmtPath)).toMatchInlineSnapshot(`"prisma-fmt 6a8054bb549e4cc23f157b0010cb2e95cb2637fb"`);
    });
